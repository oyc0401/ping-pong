...
class myball(Circle):
    ...
    def collision(self, bubson):
        ...
        # print(minus_vector)
        print(bubson)
        # print(inner(minus_vector, bubson))
...
# dot1 = Circle(2, Point(0, 0))
# dot1.setFillColor('red')
# canvas.add(dot1)
#
# dot2 = Circle(2, Point(0, 0))
# dot2.setFillColor('orange')
# canvas.add(dot2)
#
# dot3 = Circle(2, Point(0, 0))
# dot3.setFillColor('green')
# canvas.add(dot3)
#
# dot4 = Circle(2, Point(0, 0))
# dot4.setFillColor('blue')
# canvas.add(dot4)
